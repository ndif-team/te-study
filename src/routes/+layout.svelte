<script lang="ts">
	...
	import StudyShell from '~/study/StudyShell.svelte';
	import { page } from '$app/stores';

	// NOTE: upstream's `<GTM />` (Google Tag Manager / GA) is deliberately not
	// mounted in the study fork. It is inert unless VITE_GTM_ID/VITE_GA_ID are
	// set, but removing it outright means the IRB data-flow answer is simply
	// "participant data goes to our Supabase project and nowhere else", with no
	// caveat about an unset environment variable.
